...
options = _generate_options_from_flags(
    PythonEZRegex,
    {'ascii': 'a', 'ignore_case': 'i', 'single_line': 's', 'locale': 'L',
     'multiline': 'm', 'unicode': 'u'},
    docs_map={
        'locale': '''Try not to use this, and rely on unicode matching instead''',
    },
    docs_link='https://docs.python.org/3/library/re.html#flags'
)
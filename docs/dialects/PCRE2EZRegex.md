...
Args:
    global:
        Global mode. Match everything in the given string, instead of just the first match
    multiline:
    ...
    verbose:
        Not recommended. Allows for comments and whitespace, which both don't do anything in this library.
    single_line:
    ...
    lazy:
        The engine will per default to lazy matching, instead of greedy. It's recommended you just specify greedy=False instead
    duplicate_groups:
    ...
    noncapturing:
        Not recomendded. Don't capture with any groups. Instead, simply don't use any groups
